...
var FileTransferObject = /** @class */ (function () {
    ...
    FileTransferObject.prototype.upload = function (fileUrl, url, options, trustAllHosts) { return Object(_awesome_cordova_plugins_core__WEBPACK_IMPORTED_MODULE_2__["cordovaInstance"])(this, "upload", { "successIndex": 2, "errorIndex": 3 }, arguments); };
    FileTransferObject.prototype.download = function (source, target, trustAllHosts, options) { return Object(_awesome_cordova_plugins_core__WEBPACK_IMPORTED_MODULE_2__["cordovaInstance"])(this, "download", { "successIndex": 2, "errorIndex": 3 }, arguments); };
    ...
    FileTransferObject.prototype.abort = function () { return Object(_awesome_cordova_plugins_core__WEBPACK_IMPORTED_MODULE_2__["cordovaInstance"])(this, "abort", { "sync": true }, arguments); };
...
/* harmony import */ var _awesome_cordova_plugins_file_transfer_ngx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @awesome-cordova-plugins/file-transfer/ngx */ "jBhA");
...
// declare var File2:any;
// import { File } from '@ionic-native/file/ngx';

let ConferintaPage = class ConferintaPage {
    constructor(transfer, file, menu, router, authService, http) {
    ...
    downloadFile(nume_fisier) {
        this.http.get(`127.0.0.1:8000/api/conferinta/filedownload/${nume_fisier}`)
            .subscribe((response) => {
