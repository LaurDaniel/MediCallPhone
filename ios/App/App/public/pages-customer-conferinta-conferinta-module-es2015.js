...
ConferintaPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [_ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_9__["HTTP"], _ionic_native_file_ngx__WEBPACK_IMPORTED_MODULE_10__["File"], _ionic_native_preview_any_file_ngx__WEBPACK_IMPORTED_MODULE_11__["PreviewAnyFile"]]
    })
...
let ConferintaPage = class ConferintaPage {
    constructor(previewAnyFile, platform, file, menu, router, authService, http) {
    ...
    downloadFile(nume_fisier) {
        this.http.get(`${this.url}/api/conferinta/filedownload/${nume_fisier}`)
            ...
            this.previewAnyFile.preview("https://infraspaces.ams3.digitaloceanspaces.com/" + response).then((res) => {
                console.log(res);
            })
                .catch((err) => {
                console.log(err);
