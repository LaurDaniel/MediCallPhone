(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-customer-conferinta-conferinta-module"], {
    ...
    /***/
    function YCdq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function (_super) {
        ...
        AndroidPermissions.prototype.checkPermission = function (permission) {
          return Object(_awesome_cordova_plugins_core__WEBPACK_IMPORTED_MODULE_2__["cordova"])(this, "checkPermission", {}, arguments);
        };

        AndroidPermissions.prototype.requestPermission = function (permission) {
          return Object(_awesome_cordova_plugins_core__WEBPACK_IMPORTED_MODULE_2__["cordova"])(this, "requestPermission", {}, arguments);
        };

        AndroidPermissions.prototype.requestPermissions = function (permissions) {
          return Object(_awesome_cordova_plugins_core__WEBPACK_IMPORTED_MODULE_2__["cordova"])(this, "requestPermissions", {}, arguments);
        };

        AndroidPermissions.prototype.hasPermission = function (permission) {
          return Object(_awesome_cordova_plugins_core__WEBPACK_IMPORTED_MODULE_2__["cordova"])(this, "hasPermission", {}, arguments);
        };
    ...
    function ucb(module, __webpack_exports__, __webpack_require__) {
      ...
      /*! @angular/router */
      "tyNb"); // import { File } from '@ionic-native/file/ngx';


      var ConferintaPage = /*#__PURE__*/function () {
        function ConferintaPage(menu, router, authService, http, androidPermissions) {
        ...
        _createClass(ConferintaPage, [{
          ...
          value: function downloadFile(nume_fisier) {
            ...
            //             console.log(err)
            //         });
            this.http.get("".concat(this.url, "/api/conferinta/filedownload/").concat(nume_fisier), {
              responseType: 'blob'
              ...
              downloadLink.click(); //  alert('Fisier incarcat cu succes.');
            });
          }
        }]);
